...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('academics_usermeta', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(
                to=orm['academics.User'])),
            ('meta', self.gf('django.db.models.fields.related.ForeignKey')(
                to=orm['academics.UserMetaType'])),
        ...
        db.create_table('academics_course', (
            ...
            ('subject_en',
             self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('semester',
             self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('language',
             self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('courseProject',
             self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_unique('academics_course_professors',
                         ['course_id', 'user_id'])
    ...
    models = {
        'academics.course': {
            ...
            {'to': "orm['academics.User']", 'symmetrical': 'False',
             'blank': 'True'}),
            'semester': (
        ...
        'academics.usermeta': {
            ...
            'id': (
            'django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meta': ('django.db.models.fields.related.ForeignKey', [],
                     {'to': "orm['academics.UserMetaType']"}),
